...
import { Wallet, Eye, EyeOff, CheckCircle2, Target, BarChart3 } from 'lucide-react'
    ...
    <div className="min-h-screen  flex ">
      ...
      <div className="w-full  lg:w-1/2 flex flex-col justify-center px-8 lg:px-40 py-12 bg-[#020817]">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-semibold text-white mb-2">Bienvenido de vuelta</h1>
          <p className="text-gray-400">Inicia sesión para continuar con Quipu</p>
        </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-16 py-12 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
        <div className="max-w-lg mx-auto">
          <h2 className="text-4xl font-bold text-white mb-4">Toma el control de tus finanzas</h2>
          <p className="text-gray-400 text-lg mb-12">Gestiona tus ingresos, gastos y metas de ahorro con una aplicación intuitiva y potente.</p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white font-semibold mb-1">Seguimiento automático</h3>
                  <p className="text-gray-400 text-sm">Registra tus movimientos automáticamente con IA o manualmente en segundos.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white font-semibold mb-1">Metas personalizadas</h3>
                  <p className="text-gray-400 text-sm">Define objetivos de ahorro y sigue tu progreso en tiempo real.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white font-semibold mb-1">Reportes detallados</h3>
                  <p className="text-gray-400 text-sm">Analiza tus patrones de gasto con gráficos y estadísticas claras.</p>
                </div>
              </div>
            </div>
          </div>
